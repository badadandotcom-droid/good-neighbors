...
export const HOMEPAGE_FAQS = [
  ...
  },
  {
    ...
    a: "Price depends on whether the nest is visible ($180) or hidden ($250), whether more than one nest needs treatment ($100 each), and how high the nest or entry point is — under 10 ft is included in your service price, 10–35 ft adds a $75 ladder fee, and over 35 ft is quoted separately.",
  },
  {
    q: "How quickly will the wasps be gone?",
    a: "Activity can stop the same day, although some nests take longer after treatment. We'll explain what to expect for your particular job.",
