...
export const HOMEPAGE_FAQS = [
  ...
  },
  {
    ...
    a: "Price depends on whether the nest is visible ($180 + HST) or hidden ($220 + HST), whether more than one nest needs treatment (+$80 + HST each), and whether a ladder is required — the ladder fee depends on the job and is discussed with you before any work begins.",
  },
  {
    q: "How quickly will the wasps be gone?",
    a: "Activity can stop the same day, although some nests take longer after treatment. We'll explain what to expect for your particular job.",
