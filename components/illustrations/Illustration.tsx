...
const paths: Record<IllustrationId, React.ReactNode> = {
  ...
  skunk: (
    <>
      <Hatch>
        <path d="M22 62c3.4-2.6 7.4-4.2 11.6-4.6M64 62c5-2.4 10.6-3 16-2" />
      </Hatch>
      <path d="M14 78c0-12 10-21.5 24-21.5 7.4 0 13 1.8 17.5 5.5" />
      <circle cx="24" cy="66" r="1.8" fill="currentColor" stroke="none" />
      <path d="M10 60c-.8-3.6.8-6.6 4-8" />
      <path d="M62 61c15-7.4 31.5-2.6 37 12 4.8 12.6-1.8 25-15 29-11 3.2-22-1-27-11" />
      <path d="M70 62.5c5.6-2.2 11.6-1 16 3.2 5.4 5.2 6.2 13 1.8 19.2" />
      <path d="M78 64.5c3.4-1 7-.4 9.8 1.8" />
      <path d="M14 78c-1.2 7.4 2.6 13.6 9.4 16.6" />
    </>
  ),
  bird: (
    <>
